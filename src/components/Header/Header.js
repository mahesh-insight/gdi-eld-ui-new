...
const navItems = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Azure Plan Unbilled Consumption", href: "/cloud/azure-unbilled" },
...
const Header = () => {
  ...
  return (
    <header className={styles.header} ref={headerRef}>
          ...
          <div className={styles.logo}>
            <Link href="/">
              <svg viewBox="0 -20 460 140" className={styles.svg}>
                ...
                <g>
                  <g id="Symbol">
                    <path fill="#721357" d="M60.6,89.7V42.9h11.8v46.7H60.6z M73.6,11c0-4-3.1-7.2-7.1-7.2c-4,0-7.2,3.2-7.2,7.2c0,4,3.2,7.1,7.2,7.1 C70.5,18.1,73.6,15,73.6,11z" />
                    <path fill="#AE0A46" d="M35.4,6.3V53H23.6V6.3H35.4z M22.3,84.9c0,4,3.1,7.2,7.1,7.2c4,0,7.2-3.2,7.2-7.2c0-4-3.2-7.1-7.2-7.1 C25.4,77.9,22.3,81,22.3,84.9z" />
      ...
      <div className={`${styles.fullScreenDropdown} ${hasOpenMenuWithChildren ? styles.open : ""}`}>
        <div className={styles.activeIndicatorBar} style={{ opacity: hasOpenMenuWithChildren ? 1 : 0 }}>
